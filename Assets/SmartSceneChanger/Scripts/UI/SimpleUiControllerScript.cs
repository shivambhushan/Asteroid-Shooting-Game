...
namespace SSC
{
    ...
    public class SimpleUiControllerScript : UiControllerScript
    {
        ...
        /// <summary>
        /// Disable CanvasGroup.interactable after hiding
        /// </summary>
        [SerializeField]
        [Tooltip("Disable CanvasGroup.interactable after hiding")]
        protected bool m_disableInteractableAfterHiding = true;

        /// <summary>
        /// Disable CanvasGroup.blocksRaycasts after hiding
        /// </summary>
        [SerializeField]
        [Tooltip("Disable CanvasGroup.blocksRaycasts after hiding")]
        protected bool m_disableBlocksRaycastsAfterHiding = true;
        ...
        /// <summary>
        /// UnityEvent at showing finished
        /// </summary>
        [SerializeField]
        [Tooltip("UnityEvent at showing finished")]
        protected UnityEvent m_eventAtShowingFinished;

        /// <summary>
        /// UnityEvent at hiding start
        /// </summary>
        [SerializeField]
        [Tooltip("UnityEvent at hiding start")]
        protected UnityEvent m_eventAtHidingStart;
        ...
        protected virtual void Awake()
        {
            ...
            if (this.m_hideAtAwake)
            {
                ...
                this.m_refCanvasGroup.interactable = !this.m_disableInteractableAfterHiding;
                this.m_refCanvasGroup.blocksRaycasts = !this.m_disableBlocksRaycastsAfterHiding;
        ...
        protected override IEnumerator show()
        {
            ...
            // finish
            {
                ...
                this.m_eventAtShowingFinished.Invoke();
        ...
        protected override IEnumerator hide()
        {
            ...
            // init
            {
                ...
                if(this.m_disableInteractableAfterHiding)
                {
                    this.m_refCanvasGroup.interactable = false;
                }
                
                this.m_eventAtHidingStart.Invoke();
            ...
            // finish
            {
                ...
                if(this.m_disableBlocksRaycastsAfterHiding)
                {
